    ...
    const enemyStyle = {
      ...
      return (
        <Fragment>
          ...
          <h4 style={{color:'red', width:'max-content', maxWidth:`${size}px`, marginBottom:'-40px', zIndex:'4'}}>{enemy.name}</h4>
          <h4 className='enemyName' style={{color:'red', width:'max-content', maxWidth:`${size}px`}}>{enemy.name}</h4>
